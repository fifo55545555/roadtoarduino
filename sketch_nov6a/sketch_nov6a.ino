// 27cm/s -rchlosť robota
// zistiť dialku aku dojazdi po vypnuti motora (cm)
// musime spraviť abz sa otáčal okolo stredu krzžovatky
int tas=0;
...
void loop() {
   ...
   if(button){
      if(tas >= 3){
         stop() //vpred(0); // ked dojazdi + vpred(int del) tak aby stred robota bol v strede krizovatky
